                ...
                <div class="row">
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <select name="gender" class="form-control">
                            <option {{ old('gender')=='1' ? 'selected' : '' }} value="1">{{__('Male')}}</option>
                            <option {{ old('gender')=='0' ? 'selected' : '' }} value="0">{{__('Female')}}</option>
                            <option {{ old('gender')=='2' ? 'selected' : '' }} value="2">{{__('Rather Not Say')}}</option>
...
{{--                            value="{{ old('address') }}">--}}
                ...
                <div class="row">
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <input type="url" name="facebook" class="form-control" placeholder="{{__('Facebook')}}"
                               value="{{ old('facebook') }}">
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <input type="url" name="linkedin" class="form-control" placeholder="{{__('Linkedin')}}"
                               value="{{ old('linkedin') }}">
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <input type="url" name="instagram" class="form-control" placeholder="{{__('Instagram')}}"
                               value="{{ old('instagram') }}">
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <input type="url" name="youtube" class="form-control" placeholder="{{__('Youtube')}}"
                               value="{{ old('youtube') }}">
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <input type="url" name="website" class="form-control" placeholder="{{__('Website')}}"
                               value="{{ old('website') }}">
                ...
                <div class="form-group">
                    <div>
                        ...
                        <a class="btn btn-danger waves-effect" href="{{ route('students.index') }}">
