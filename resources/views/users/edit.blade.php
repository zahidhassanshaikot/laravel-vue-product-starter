...
{{--                                    <option {{ old('type', $user->type) == '' ? 'selected' : '' }} value="">{{ __('Select User Type') }}</option>--}}
                                    <option {{ old('type', $user->type) == 'Admin' ? 'selected' : 'selected' }} value="Admin">{{ __('Admin') }}</option>
                                    <option {{ old('type', $user->type) == 'Manager' ? 'selected' : '' }} value="Manager">{{ __('Manager') }}</option>
                                </select>
                            </div>
                            @error('type')
                            <p class="error">{{ $message }}</p>
